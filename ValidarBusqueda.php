		...
		<table border="1" class="table table-bordered">
			...
			<tbody>
				<!--
					...
					cursores :)
				-->
				<?php while ($bus = $sentencia->fetchObject()){ ?>
					<tr>
						<td><?php echo $bus->nombre_cueva ?></td>
                                                <td><?php echo $bus->longitud ?></td>
                                                <td><?php echo $bus->latitud ?></td>
                                                <td><?php echo $bus->nombre_ciudad ?></td>
						<td><?php echo $bus->nombre_departamento ?></td>
                                                <td><?php echo $bus->nombre_flora ?></td>
                                                <td><?php echo $bus->nombre_especieflora ?></td>
                                                <td><?php echo $bus->nombre_fauna ?></td>
                                                <td><?php echo $bus->nombre_especiefauna ?></td>
                                                <td><?php echo $bus->nombre_tipo ?></td>
					</tr>
				<?php } ?>
			</tbody>
		</table>
