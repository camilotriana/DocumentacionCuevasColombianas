...
<div class="row">
	...
	<div class="col-12">
            <br><br>
		<h1>AGREGAR ESPECIE DE FLORA</h1>
                <br><br>
		<form action="InsertarEFlora.php" method="POST">
                       <div class="form-group">
				<label for="id_especie">ID ESPECIE DE FLORA</label>
				<input required name="id_especie" type="number" id="id_especie" placeholder="id especie flora" class="form-control">
			<div class="form-group">
				<label for="nombre">NOMBRE ESPECIE DE FLORA</label>
